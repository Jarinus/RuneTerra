package com.runeterra.world.collision.region;

import java.util.ArrayList;

import com.runeterra.RuneTerra;
import com.runeterra.cache.impl.CacheArchive;
import com.runeterra.cache.impl.CacheConstants;
import com.runeterra.cache.impl.definitions.ObjectDefinition;
import com.runeterra.world.collision.buffer.ByteStreamExt;
...
public final class RegionClipping {
	...
	public static void init() {
		try {
			...
			CacheArchive archive = RuneTerra.getCache().getArchive(CacheConstants.MANIFEST_ARCHIVE);
	...
	public static void loadRegion(int x, int y) {
		...
		try {
			...
			byte[] objectData = RuneTerra.getCache().getDecompressedFile(CacheConstants.MAP_INDEX,
					r.regionData.objectFile);
			byte[] terrainData = RuneTerra.getCache().getDecompressedFile(CacheConstants.MAP_INDEX,
