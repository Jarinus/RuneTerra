package com.runeterra.world.model.container.impl;
...
import com.runeterra.world.model.container.ItemContainer;
import com.runeterra.world.model.container.StackType;
import com.runeterra.world.model.equipment.BonusManager;
import com.runeterra.world.model.syntax.impl.SearchBank;
...
public class Bank extends ItemContainer {
	...
	public Bank refreshItems() {
		...
		if (getPlayer().isSearchingBank()) {
			...
			getPlayer().getPacketSender().sendString(5383, "Bank of RuneTerra").sendConfig(117, 0);
		}
