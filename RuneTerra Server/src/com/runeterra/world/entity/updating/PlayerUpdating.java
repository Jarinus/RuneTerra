...
import com.runeterra.net.packet.ByteOrder;
import com.runeterra.net.packet.PacketBuilder;
import com.runeterra.net.packet.PacketBuilder.AccessType;
import com.runeterra.net.packet.ValueType;
import com.runeterra.world.World;
import com.runeterra.world.entity.Entity;
...
public class PlayerUpdating {
	...
	private static void updateAppearance(Player player, PacketBuilder out, Player target) {
		...
		if (skillAnim > 0) {
			...
			properties.putShort(wep.getStandTurnAnim()); // 0x337
			properties.putShort(wep.getWalkAnim());
			properties.putShort(wep.getTurn180Anim()); // 0x334
			properties.putShort(wep.getTurn90CWAnim()); // 0x335
			properties.putShort(wep.getTurn90CCWAnim()); // 0x336
