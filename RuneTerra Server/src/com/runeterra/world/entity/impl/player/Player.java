...
package com.runeterra.world.entity.impl.player;
...
import com.runeterra.engine.task.impl.CombatPoisonEffect;
import com.runeterra.engine.task.impl.OverloadPotionTask;
import com.runeterra.engine.task.impl.PlayerDeathTask;
import com.runeterra.engine.task.impl.PlayerSpecialAmountTask;
import com.runeterra.engine.task.impl.WalkToTask;
import com.runeterra.net.PlayerSession;
import com.runeterra.net.SessionState;
import com.runeterra.net.packet.PacketSender;
import com.runeterra.util.FrameUpdater;
import com.runeterra.util.Stopwatch;
import com.runeterra.world.World;
import com.runeterra.world.content.PrayerHandler;
import com.runeterra.world.content.ServerFeed;
import com.runeterra.world.content.Trading;
import com.runeterra.world.content.clan.ClanChat;
import com.runeterra.world.content.clan.ClanChatManager;
import com.runeterra.world.content.skills.SkillManager;
...
import com.runeterra.world.entity.combat.magic.Autocasting;
...
import com.runeterra.world.entity.impl.npc.NpcAggression;
import com.runeterra.world.model.Animation;
import com.runeterra.world.model.Appearance;
import com.runeterra.world.model.ChatMessage;
import com.runeterra.world.model.EffectTimer;
import com.runeterra.world.model.Flag;
import com.runeterra.world.model.ForceMovement;
import com.runeterra.world.model.Locations;
import com.runeterra.world.model.MagicSpellbook;
import com.runeterra.world.model.PlayerInteractingOption;
import com.runeterra.world.model.PlayerRelations;
import com.runeterra.world.model.PlayerRights;
import com.runeterra.world.model.PlayerStatus;
import com.runeterra.world.model.SecondsTimer;
...
import com.runeterra.world.model.container.impl.PriceChecker;
import com.runeterra.world.model.container.impl.Shop;
import com.runeterra.world.model.dialogue.Dialogue;
import com.runeterra.world.model.dialogue.DialogueOptions;
...
public class Player extends Character {
	...
	public float getBaseAttackSpeed() {
		...
		float speed = getCombat().getWeapon().getSpeed();
	...
	private String clanChatName = "RuneTerra";
