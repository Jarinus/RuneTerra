...
import com.runeterra.world.entity.impl.CharacterList;
...
import com.runeterra.world.entity.updating.NpcUpdateSequence;
import com.runeterra.world.entity.updating.PlayerUpdateSequence;
import com.runeterra.world.entity.updating.UpdateSequence;
...
public class World {
	...
	public static void sequence() {
		...
		while ($it.hasNext()) {
			...
			boolean force_logout = RuneTerra.isUpdating()
