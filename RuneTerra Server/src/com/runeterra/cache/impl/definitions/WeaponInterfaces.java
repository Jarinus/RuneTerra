package com.runeterra.cache.impl.definitions;

import java.util.HashMap;
import java.util.Map;

import com.runeterra.GameConstants;
import com.runeterra.util.JsonLoader;
import com.runeterra.world.entity.combat.CombatSpecial;
import com.runeterra.world.entity.combat.FightType;
...
public final class WeaponInterfaces {
    ...
    public enum WeaponInterface {
        ...
        GRANITE_MAUL(425,
                     428,
                     6,
                     new FightType[]{FightType.GRANITE_MAUL_POUND,
        ...
        SCYTHE(776,
               779,
               4,
               new FightType[]{FightType.SCYTHE_REAP,
        ...
        GREATAXE(1698,
                 1701,
                 5,
                 new FightType[]{FightType.GREATAXE_CHOP,
        ...
        MACE(3796,
             3799,
             5,
             new FightType[]{FightType.MACE_POUND, FightType.MACE_PUMMEL, FightType.MACE_SPIKE, FightType.MACE_BLOCK},
             7624,
             7636
        ),
        KNIFE(4446,
        ...
        SPEAR(4679,
              4682,
              5,
              new FightType[]{FightType.SPEAR_LUNGE,
        ...
        TWO_HANDED_SWORD(4705,
                         4708,
                         6,
                         new FightType[]{FightType.TWOHANDEDSWORD_CHOP,
        ...
        PICKAXE(5570,
                5573,
                5,
                new FightType[]{FightType.PICKAXE_SPIKE,
        ...
        CLAWS(7762,
              7765,
              5,
              new FightType[]{FightType.CLAWS_CHOP,
        ...
        THROWNAXE(4446,
                  4449,
                  4,
                  new FightType[]{FightType.THROWNAXE_ACCURATE,
        ...
        for (FightType type : weapon.getFightType()) {
            if (type.getStyle() == player.getCombat().getFightType().getStyle()) {
                ...
                player.getPacketSender()
                        .sendConfig(player.getCombat().getFightType().getParentId(),
