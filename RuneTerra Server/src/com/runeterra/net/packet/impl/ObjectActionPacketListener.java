...
import com.runeterra.engine.task.impl.ForceMovementTask;
...
import com.runeterra.script.ScriptManager;
...
import com.runeterra.world.regions.AreaHandler;
...
//         }
        ...
        player.setWalkToTask(new WalkToTask(player, position, gameObject.getSize(), () -> {
            ...
            switch (id) {
                ...
                default:
                    Consumer<ObjectClickContext> handler = ScriptManager.objectBehavior.getFirstClickHandlers().get(id);
                    if (handler != null) {
                        ObjectClickContext context = new ObjectClickContext(player, gameObject);
    ...
    private static void secondClick(final Player player, Packet packet) {
        ...
        player.setWalkToTask(new WalkToTask(player, position, gameObject.getSize(), () -> {
            switch (id) {
                ...
                default:
                    Consumer<ObjectClickContext> handler = ScriptManager.objectBehavior.getSecondClickHandlers().get(id);
                    if (handler != null) {
                        ObjectClickContext context = new ObjectClickContext(player, gameObject);
                        handler.accept(context);
                    } else {
